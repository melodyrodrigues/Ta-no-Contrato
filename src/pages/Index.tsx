    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="gradient-hero">
        <div className="container max-w-5xl mx-auto px-6 pt-14 pb-20 md:pt-16 md:pb-24 text-center relative z-10">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-heading text-primary-foreground mb-3 tracking-tight text-balance animate-float">
            Tá no Contrato
          </h1>
        ...
        <section className="container max-w-5xl mx-auto px-6 -mt-10 relative z-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {FEATURES.map(({ icon: Icon, title, desc, delay }) => (
              <div
                key={title}
                className="group rounded-2xl bg-card shadow-premium border border-border/50 p-6 text-center hover:shadow-card-hover hover:-translate-y-1.5 transition-all duration-500 ease-out animate-fade-in-up"
