  ...
  return (
    <div className="w-full max-w-3xl mx-auto space-y-10 animate-fade-in">
      ...
      <Textarea
        ...
        className="min-h-[240px] md:min-h-[260px] resize-y rounded-2xl border-border bg-white text-foreground text-lg leading-relaxed font-body placeholder:text-muted-foreground focus:ring-2 focus:ring-primary/15 focus:border-primary/30 transition-all duration-300 p-5 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-100"
      />
